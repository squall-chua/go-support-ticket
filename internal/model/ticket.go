...
type TicketType struct {
	...
	AutoVisible     bool          `json:"auto_visible" bson:"auto_visible"`
...
func (m *Ticket) ToProto() (*apiv1.Ticket, error) {
	t := &apiv1.Ticket{
		...
		MergedInto:  func() string { if m.MergedInto.IsZero() { return "" }; return m.MergedInto.Hex() }(),
		CreatedAt:   timestamppb.New(m.CreatedAt),
		UpdatedAt:   timestamppb.New(m.UpdatedAt),
		DeletedAt:   func() *timestamppb.Timestamp { if m.DeletedAt == nil { return nil }; return timestamppb.New(*m.DeletedAt) }(),
	}
...
func (c Comment) ToProto() *apiv1.Comment {
	return &apiv1.Comment{
		Id:        func() string { if c.ID.IsZero() { return "" }; return c.ID.Hex() }(),
		Author:    c.Author,
		Content:   c.Content,
